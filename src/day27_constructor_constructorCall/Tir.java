...
public class Tir {
		...
		public Tir(int i, String string, String string2, int j, boolean b) {
			...
			// tir runner classindan yolladýgýmýz degerlerin instance variablelar ile eslesmesi icin
	//atamalari yapmam lazim		
		...
		public Tir(int km, String model, String renk) {
			...
			//daha anlasýlýr olmasi icin variable isimlerini anlamli yapalim
			//int km, String model, String renk
			
			this.km=km;
			this.model=model;
			this.renk=renk;
			//basina this. yazdýgýmýzda java bu variablenin class leveldaki oldugunu anlar, yani yukaridakilerini
		}
